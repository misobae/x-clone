      ...
      <li>
        <Link href="/home">
          <div className={style.navPill}>
            ...
            <div style={{ fontWeight: segment === 'home' ? 'bold' : 'normal' }}>Home</div>
          </div>
        </Link>
      </li>
      <li>
        <Link href="/explore">
          <div className={style.navPill}>
            ...
            <div style={{ fontWeight: segment  && (['search', 'explore'].includes(segment)) ? 'bold' : 'normal' }}>Explore</div>
          </div>
        </Link>
      </li>
      <li>
        <Link href="/messages">
          <div className={style.navPill}>
            ...
            <div style={{ fontWeight: segment === 'messages' ? 'bold' : 'normal' }}>Messages</div>
          </div>
        </Link>
      </li>
      {me?.user?.id && <li>
        <Link href={`/${me.user.id}`}>
          <div className={style.navPill}>
            ...
            <div style={{ fontWeight: segment === me.user.id ? 'bold' : 'normal' }}>Profile</div>
          </div>
        </Link>
      </li>}
    </>
